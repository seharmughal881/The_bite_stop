  ...
  useEffect(() => {
    const loadProducts = async () => {
      try {
        ...
        const response = await productsService.getAllDesserts();

        // Check if response has products array or if it's the direct array
        const dessertsData = response.products || response;

        if (!Array.isArray(dessertsData)) {
        ...
        const flavors = [
          ...new Set(
            dessertsData.map((product) => product.specs?.flavor).filter(Boolean)
          ),
        ];
        setUniqueFlavors(flavors);

        // Enhance products with images array and calculate discount percentages
        const enhancedProducts = dessertsData.map((product) => ({
          ...product,
    ...
    <div className="mx-auto py-8 px-6 md:px-10 relative overflow-hidden">
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/hoto-1551024506-0bccd828d307?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1980&q=80')",
          }}
        ></div>

        {/* Decorative dessert elements */}
              ...
              >
                ...
                >
                  ...
                  <div className="relative overflow-hidden rounded-t-2xl">
                    ...
                    {/* Discount badge - UPDATED to show percentage */}
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between mb-4">
                      ...
                      {/* Discount percentage badge - ADDED to card */}
                      {product.discountPercentage > 0 && (
...
export function AllDessertsProducts() {
    ...
    <div className="mx-auto px-8 md:mt-15 mt-2 py-12 relative">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-155102406-0bccd828d307?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1980&q=80')",
          }}
        ></div>
