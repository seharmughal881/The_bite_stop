// src/app/all-cupcakes-creation/page.jsx
"use client";
import { useEffect } from "react";
import { useRouter } from "next/navigation";

export default function AllCupcakesPage() {
  const router = useRouter();
  
  useEffect(() => {
    // Redirect to fast food equivalent
    router.replace("/all-shawarmas-creation");
  }, [router]);
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-[#fff5f8] to-[#ffeef3]">
      <div className="text-center">
        ...
        <p className="text-gray-600">Redirecting to Shawarma menu...</p>
      </div>
    </div>
  );
}
